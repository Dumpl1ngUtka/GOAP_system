...
2. Check if the file exists. If not, create it using the template from `.gemini/skills/unikit-todo/assets/todo-template.md`
...
3. Read the task entry template from `.gemini/skills/unikit-todo/assets/task-entry-template.md`
