...
2. **Base skill `.gemini/skills/<skill>/SKILL.md`** — does the base skill already include this behavior?
...
4. Cross-check against base `.gemini/skills/<skill>/SKILL.md` — if base already covers the rule, skip and report
