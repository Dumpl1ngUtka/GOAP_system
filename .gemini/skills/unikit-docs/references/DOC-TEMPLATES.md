...
- Unity Hub with Unity **X.Y.Z** installed
- [Other requirements]
...
Open the project in Unity Hub. Wait for package resolution. Open `Assets/Scenes/Bootstrap.Unity` and press Play.
...
### Prerequisites
- Unity version (exact, from ProjectVersion.txt)
- Required Unity modules (Android Build Support, iOS Build Support if mobile)
- IDE (Rider, VS Code with Unity extension)
...
| Scene | Path | Purpose |
|-------|------|---------|
| Bootstrap | `Assets/Game/Scenes/Bootstrap.Unity` | App entry point |
| ... | ... | ... |
...
**Goal:** Custom Unity Editor extensions in the project.
