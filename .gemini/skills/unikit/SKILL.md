...
All unikit artifacts live under fixed default paths (`.unikit/DESCRIPTION.md`, `.unikit/ARCHITECTURE.md`, `.unikit/RULES.md`, `.unikit/memory/`, `.unikit/plans/`, etc.) — see `.gemini/skills/unikit/references/config-template.yaml` for the canonical `language` / `workflow` / `git` schema.
...
1. `mkdir -p .unikit`
2. Read `.gemini/skills/unikit/references/config-template.yaml`.
...
2. Read `.gemini/skills/unikit/references/LANGUAGE_RULES_TEMPLATE.md`.
...
This skill requires `.gemini/skills/unikit/references/ENGINE_RULES.md` to exist.
...
If `.gemini/skills/unikit/references/ENGINE_RULES.md` does not exist, stop and inform the user:
> "Engine rules not found. Run the UniKit installer first to select your game engine."

Read `.gemini/skills/unikit/references/ENGINE_RULES.md` once and use it throughout all subsequent steps.

---

### Step 6: Project Scan

Check for engine project indicators listed in the **"Engine Detection"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
...
Read the project settings file specified in the **"Project Settings"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
Extract the fields listed there: engine version, target platform, renderer, project name.

**2.2 Package Dependencies**

Read the package manifest specified in the **"Package Dependencies"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
...
Scan the plugin directory from the **"Plugin Directories"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
Use the detection table to identify known plugins by their folder indicators.

**2.4 Third-Party Assets**

Scan the third-party assets directory from the **"Third-Party Assets"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
Use the detection table to identify known assets. **Skip if the section says to skip.**

**2.5 Custom Modules**

Scan the modules directory from the **"Custom Modules"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
Skip if no modules directory convention is defined or if the directory does not exist.

**2.6 Project Scripts**

Check the common script locations listed in the **"Script Conventions"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
Determine the organizational pattern (by feature, by layer, by type).

**2.7 Module Definitions**

Find module definition files using the glob pattern from the **"Module Definitions"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
These reveal the dependency graph and module boundaries.

**2.8 Scenes**

Find scene files using the glob pattern from the **"Scene Files"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md`.
...
Read the **"Stack Selection Options"** section of `.gemini/skills/unikit/references/ENGINE_RULES.md` — it contains the available options for each category with engine-specific descriptions and notes.
...
Use the **"Project Structure Template"** and **"Key Entry Points"** from `.gemini/skills/unikit/references/ENGINE_RULES.md`
