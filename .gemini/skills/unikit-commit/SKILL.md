...
# Unity Commit Generator

Generate commit messages following the [Conventional Commits](https://www.conventionalcommits.org/) specification, with Unity-specific safety checks.
...
2. Run Unity safety checks (meta pairing, ignored dirs, binary assets, secrets)
